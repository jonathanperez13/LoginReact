...
function Conversor() {
  ...
  function convertirTextoAVoz() {
    ...
    const utterThi8s = new SpeechSynthesisUtterance(textoAVoz)
    synth.speak(utterThis)
  }
  function resultado(event) {
    setVozATexto(event.onresult[0][0].transcript)
  }
  ...
  function grabarVozATexto() {
    ...
    <input type="text" nid="" id="textoAVoz" value={textoAVoz} onChange={cambiarTexto} />
